...
### HashMap 1.7，1.8的差异，1.8中什么情况下转换为红黑树，构造函数中参数代表的意思。[参考：美团面试题：Hashmap的结构，1.7和1.8有哪些区别，史上最深入的分析](https://blog.csdn.net/qq_36520235/article/details/82417949)
...
### 抽象类与接口的区别[参考：Java中抽象类与接口有什么区别](https://blog.csdn.net/xiaoxu9522/article/details/90748914)
...
### 分别讲讲 final，static，synchronized 关键字可以修饰什么，以及修饰后的作用？[参考：this、super、final、static、synchronized 关键字可以修饰什么，以及修饰后的作用？](https://blog.csdn.net/qq_38127722/article/details/107013476)
